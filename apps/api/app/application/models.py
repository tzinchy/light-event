...
class Application(TimestampMixin, Base):
    ...
    application_uuid: Mapped[UUID] = mapped_column(primary_key=True, server_default=text("uuidv7()"))
...
class ApplicationEvent(Base):
    ...
    application_event_uuid: Mapped[UUID] = mapped_column(primary_key=True, server_default=text("uuidv7()"))
