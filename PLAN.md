...
- **Шифрование KYC**: объекты документов в приватном S3-бакете, ключи объектов не выдаются наружу; выдача только через подписанные URL и только роли `admin`. Компания видит **только статус**.
